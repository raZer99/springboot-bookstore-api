...
public class AuthorControllerIntegrationTests {
    ...
    public void testThatListAuthorsReturnsListOfAuthors() throws Exception {
        ...
        testAuthorEntityA.setId(null); // ✅ REMOVE ID so Hibernate knows to INSERT
    ...
    public void testThatGetAuthorReturnsHttpStatus200WhenAuthorExist() throws Exception {
        ...
        AuthorEntity savedAuthor = authorService.createAuthor(testAuthorEntityA); //getting error here
